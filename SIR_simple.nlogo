...
[
  ...
  recovered?          ;; If true, the person has recovered from an infection and cannot be reinfected
]
...
;; White is susceptible (set at beginning)
;; Green is a removed / recovered person
